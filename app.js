...
class Spotify {
  ...
  //  }
    ...
    addSongInfo() {
        ...
        songTitle.innerHTML = `${this.songs[
            this.currentSong
        ].title.toUpperCase()}`;
...
//     // makes enter key press search button
//     if (e.key === "Enter") {
//         e.preventDefault();
//         searchButton.click();
//     }
...
//
// function toggleMenu() {
//   phoneContainer.classList.toggle('menu-open');
